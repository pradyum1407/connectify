...
const LoginPage = () => {
  ...
  const {loginMutation,isLoading,error}=useLoginPage();
  ...
  return (
    <div className="h-screen flex items-center justify-center p-4 sm:p-6 md:p-8" data-theme="abyss">
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            ...
            <div className="relative aspect-square max-w-sm mx-auto">
              <img src="/Consultative sales-rafiki.png" alt="Language connection illustration" className="w-full h-full" />
            </div>
